...
# Generated by ${SCRIPT_BASENAME} on $(date -Is)
...
# Floating for common utility applications
windowrulev2 = float,class:^(pavucontrol)$
windowrulev2 = float,class:^(blueman-manager)$
windowrulev2 = float,class:^(nm-connection-editor)$
windowrulev2 = float,class:^(org.kde.polkit-kde-authentication-agent-1)$

# Floating for file dialogs and similar popups
...
# Opacity for Alacritty (excluding scratchpad)
windowrulev2 = opacity 0.94 0.88,class:^(Alacritty)$,title:^((?!AlacrittyScratchpad).)*$

# Layer rules for notifications (e.g., Mako)
layerrule = blur, mako
